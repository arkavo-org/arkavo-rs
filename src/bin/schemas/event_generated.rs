...
impl<'a> Event<'a> {
  ...
  pub fn action_type(&self) -> ActionType {
    ...
    unsafe { self._tab.get::<ActionType>(Event::VT_ACTION_TYPE, Some(ActionType::join)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EventBuilder<'a, 'b, A> {
  ...
  pub fn add_action_type(&mut self, action_type: ActionType) {
    self.fbb_.push_slot::<ActionType>(Event::VT_ACTION_TYPE, action_type, ActionType::join);
  }
  #[inline]
...
impl<'a> UserEvent<'a> {
  ...
  pub fn source_type(&self) -> EntityType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<EntityType>(UserEvent::VT_SOURCE_TYPE, Some(EntityType::stream_profile)).unwrap()}
  }
  #[inline]
  pub fn target_type(&self) -> EntityType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<EntityType>(UserEvent::VT_TARGET_TYPE, Some(EntityType::stream_profile)).unwrap()}
  }
  #[inline]
  ...
  pub fn timestamp(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(UserEvent::VT_TIMESTAMP, Some(0)).unwrap()}
  }
  #[inline]
  pub fn status(&self) -> ActionStatus {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ActionStatus>(UserEvent::VT_STATUS, Some(ActionStatus::preparing)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UserEventBuilder<'a, 'b, A> {
  ...
  pub fn add_source_type(&mut self, source_type: EntityType) {
    self.fbb_.push_slot::<EntityType>(UserEvent::VT_SOURCE_TYPE, source_type, EntityType::stream_profile);
  }
  #[inline]
  pub fn add_target_type(&mut self, target_type: EntityType) {
    self.fbb_.push_slot::<EntityType>(UserEvent::VT_TARGET_TYPE, target_type, EntityType::stream_profile);
  }
  #[inline]
  ...
  pub fn add_timestamp(&mut self, timestamp: u64) {
    self.fbb_.push_slot::<u64>(UserEvent::VT_TIMESTAMP, timestamp, 0);
  }
  #[inline]
  pub fn add_status(&mut self, status: ActionStatus) {
    self.fbb_.push_slot::<ActionStatus>(UserEvent::VT_STATUS, status, ActionStatus::preparing);
  }
  #[inline]
